# Day 3: 原生 Tool Call 与 @Tool 工具注册
...
**核心类比：** AOP/反射 Method.invoke → @Tool 自动工具描述与调用；Command Pattern → Tool Call。
...
**断点类：** `com.quant.agent.application.tool.StockQuoteTool（Day 3 实现）`

**观察：** `toolSpecification、toolCall、arguments、toolResult`
...
在 /lianghua/agent/.specs/day03_原生_tool_call_与_@tool_工具注册/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 3 / 原生 Tool Call 与 @Tool 工具注册
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 3。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day03-learning.md`](../../../prompts/day03-learning.md)
...
进入 [`/lianghua/agent/prompts/day03-engineering.md`](../../../agent/prompts/day03-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
