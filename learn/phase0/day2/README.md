# Day 2: Prompt、SystemMessage 与 Structured Outputs
...
**核心类比：** Jackson DTO + Bean Validation → Structured Output；接口代理 → AiServices。
...
**断点类：** `com.quant.agent.application.prompt.StructuredAnalysisService（Day 2 实现）`

**观察：** `原始文本、Structured DTO、schema/required 字段`
...
在 /lianghua/agent/.specs/day02_prompt、systemmessage_与_structured_outputs/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 2 / Prompt、SystemMessage 与 Structured Outputs
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 2。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day02-learning.md`](../../../prompts/day02-learning.md)
...
进入 [`/lianghua/agent/prompts/day02-engineering.md`](../../../agent/prompts/day02-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
