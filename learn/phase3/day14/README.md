# Day 14: LangGraph4j HITL interrupt 挂起与恢复
...
**核心类比：** Workflow User Task / semaphore → interrupt + resume。
...
**断点类：** `com.quant.agent.agent.graph.HitlGateNode`

**观察：** `interrupt payload、thread_id、resume command`
...
在 /lianghua/agent/.specs/day14_langgraph4j_hitl_interrupt_挂起与恢复/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 14 / LangGraph4j HITL interrupt 挂起与恢复
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 14。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day14-learning.md`](../../../prompts/day14-learning.md)
...
进入 [`/lianghua/agent/prompts/day14-engineering.md`](../../../agent/prompts/day14-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
