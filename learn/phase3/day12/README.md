# Day 12: Socratic Prompting 归因诊断
...
**核心类比：** Strategy Pattern + Diagnostic Workflow → Socratic Prompt。
...
**断点类：** `com.quant.agent.agent.socratic.SocraticDiagnoser`

**观察：** `symptom、hypotheses、evidence、confidence`
...
在 /lianghua/agent/.specs/day12_socratic_prompting_归因诊断/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 12 / Socratic Prompting 归因诊断
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 12。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day12-learning.md`](../../../prompts/day12-learning.md)
...
进入 [`/lianghua/agent/prompts/day12-engineering.md`](../../../agent/prompts/day12-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
