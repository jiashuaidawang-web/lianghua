# Day 16: Research / Strategy / Risk 多 Agent 协同
...
**核心类比：** 微服务 orchestration → 多 Agent StateGraph。
...
**断点类：** `com.quant.agent.agent.multiagent.RiskNode`

**观察：** `researchState、strategyProposal、riskDecision`
...
在 /lianghua/agent/.specs/day16_research___strategy___risk_多_agent_协同/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 16 / Research / Strategy / Risk 多 Agent 协同
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 16。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day16-learning.md`](../../../prompts/day16-learning.md)
...
进入 [`/lianghua/agent/prompts/day16-engineering.md`](../../../agent/prompts/day16-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
