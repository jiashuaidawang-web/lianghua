...
**核心类比：** Elasticsearch 倒排 + 向量检索 → Hybrid Retrieval。
...
**断点类：** `com.quant.agent.infrastructure.rag.RagRetriever`

**观察：** `query、retrieved docs、scores、rerank result`
...
在 /lianghua/agent/.specs/day15_rag：研报检索增强与混合检索/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 15 / RAG：研报检索增强与混合检索
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 15。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day15-learning.md`](../../../prompts/day15-learning.md)
...
进入 [`/lianghua/agent/prompts/day15-engineering.md`](../../../agent/prompts/day15-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
