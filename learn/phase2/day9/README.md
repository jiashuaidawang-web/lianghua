...
**断点类：** `com.quant.agent.infrastructure.mcp.McpServerConfiguration`

**观察：** `MCP tool name、input schema、result`
...
在 /lianghua/agent/.specs/day09_mcp_server_与标准工具暴露/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 9 / MCP Server 与标准工具暴露
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 9。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day09-learning.md`](../../../prompts/day09-learning.md)
...
进入 [`/lianghua/agent/prompts/day09-engineering.md`](../../../agent/prompts/day09-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
