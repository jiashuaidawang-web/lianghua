# Day 10: DSH Diff Audit 与 Gap Matrix
...
**核心类比：** Git Diff + Flyway Schema Diff → DSH Gap Matrix。
...
**断点类：** `com.quant.agent.domain.audit.DiffAuditService`

**观察：** `requirementSnapshot、actualSnapshot、gapItems`
...
在 /lianghua/agent/.specs/day10_dsh_diff_audit_与_gap_matrix/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 10 / DSH Diff Audit 与 Gap Matrix
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 10。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day10-learning.md`](../../../prompts/day10-learning.md)
...
进入 [`/lianghua/agent/prompts/day10-engineering.md`](../../../agent/prompts/day10-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
