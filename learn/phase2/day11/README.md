# Day 11: Docker Sandbox 与 Python 安全执行
...
**核心类比：** 容器隔离 / ResourceQuota → Python Sandbox。
...
**断点类：** `com.quant.agent.infrastructure.sandbox.DockerSandboxExecutor`

**观察：** `containerId、timeout、exitCode、stdout、stderr`
...
在 /lianghua/agent/.specs/day11_docker_sandbox_与_python_安全执行/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 11 / Docker Sandbox 与 Python 安全执行
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 11。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day11-learning.md`](../../../prompts/day11-learning.md)
...
进入 [`/lianghua/agent/prompts/day11-engineering.md`](../../../agent/prompts/day11-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
