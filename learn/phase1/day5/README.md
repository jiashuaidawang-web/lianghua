# Day 5: PlannerNode 与 7 Task 动态拆解
...
**核心类比：** Activiti 流程定义解析 / Job Planning → PlannerNode。
...
**断点类：** `com.quant.agent.agent.node.PlannerNode`

**观察：** `用户需求、7 Tasks、State 更新前后快照`
...
在 /lianghua/agent/.specs/day05_plannernode_与_7_task_动态拆解/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 5 / PlannerNode 与 7 Task 动态拆解
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 5。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day05-learning.md`](../../../prompts/day05-learning.md)
...
进入 [`/lianghua/agent/prompts/day05-engineering.md`](../../../agent/prompts/day05-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
