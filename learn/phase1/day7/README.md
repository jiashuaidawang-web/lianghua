...
**核心类比：** WAL / Saga snapshot → Checkpoint / Saver + thread_id。
...
**断点类：** `com.quant.agent.infrastructure.checkpoint.CheckpointAdapter`

**观察：** `thread_id、checkpoint、resume input`
...
在 /lianghua/agent/.specs/day07_checkpoint___saver_与断点续传/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 7 / Checkpoint / Saver 与断点续传
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 7。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day07-learning.md`](../../../prompts/day07-learning.md)
...
进入 [`/lianghua/agent/prompts/day07-engineering.md`](../../../agent/prompts/day07-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
