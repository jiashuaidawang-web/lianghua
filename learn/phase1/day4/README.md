# Day 4: LangGraph4j 核心概念与 QuantAgentState
...
stateDiagram-v2
    ...
    state "QuantAgentState" as State
    Planner --> State
    Executor --> State
    Reviewer --> State
```
...
**核心类比：** Spring StateMachine / Workflow Context → StateGraph + QuantAgentState。
...
**断点类：** `com.quant.agent.agent.graph.QuantGraphFactory（Day 4 实现）`

**观察：** `state、node、edge、RunnableConfig/thread_id`
...
在 /lianghua/agent/.specs/day04_langgraph4j_核心概念与_quantagentstate/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 4 / LangGraph4j 核心概念与 QuantAgentState
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 4。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day04-learning.md`](../../../prompts/day04-learning.md)
...
进入 [`/lianghua/agent/prompts/day04-engineering.md`](../../../agent/prompts/day04-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
