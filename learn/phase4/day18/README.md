...
**核心类比：** Batch Job + Analytics Report → Backtest Engine。
...
**断点类：** `com.quant.agent.infrastructure.backtest.BacktestRunner`

**观察：** `equityCurve、returns、sharpe、maxDrawdown`
...
在 /lianghua/agent/.specs/day18_回测引擎与风险指标/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 18。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day18-learning.md`](../../../prompts/day18-learning.md)
...
进入 [`/lianghua/agent/prompts/day18-engineering.md`](../../../agent/prompts/day18-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
