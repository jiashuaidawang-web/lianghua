...
**核心类比：** Integration Test + Chaos/Load Test → E2E Agent Reliability。
...
**断点类：** `com.quant.agent.e2e.AgentScenarioTest`

**观察：** `traceId、retryCount、latency、failure injection`
...
在 /lianghua/agent/.specs/day19_e2e_闭环与鲁棒性压测/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 19 / E2E 闭环与鲁棒性压测
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 19。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day19-learning.md`](../../../prompts/day19-learning.md)
...
进入 [`/lianghua/agent/prompts/day19-engineering.md`](../../../agent/prompts/day19-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
