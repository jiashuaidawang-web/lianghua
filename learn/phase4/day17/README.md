...
**核心类比：** WebSocket/STOMP/Event Stream → AgentEvent Gateway。
...
**断点类：** `com.quant.agent.interfaces.stream.AgentEventPublisher`

**观察：** `eventType、sequence、taskId、payload`
...
在 /lianghua/agent/.specs/day17_sse___websocket_实时事件网关/ 创建/更新：
spec.md
plan.md
tasks.md
checklist.md

主题：Day 17 / SSE / WebSocket 实时事件网关
...
```text
严格按照刚才的 spec/plan/tasks 在 /lianghua/agent 中实现 Day 17。
...
完整导师 Prompt：[`/lianghua/learn/prompts/day17-learning.md`](../../../prompts/day17-learning.md)
...
进入 [`/lianghua/agent/prompts/day17-engineering.md`](../../../agent/prompts/day17-engineering.md)，让 Claude/Cursor 在现有工程上做纵向增量，不创建第二套 Demo。
